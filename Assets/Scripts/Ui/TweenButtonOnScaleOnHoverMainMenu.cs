...
namespace Ui
{
    ...
    public class TweenButtonOnScaleOnHoverMainMenu : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public Color32 standard = new Color32(255,255,255,255);
        ...
        {
            rectTransform.localScale = rectTransform.localScale.With(x: 1f);
        ...
        {
            rectTransform.localScale = rectTransform.localScale.With(x: 1f);
            tween = rectTransform.DOScaleX(1.0f, outDuration).SetEase(easeOut); 
